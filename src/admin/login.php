...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!empty($username) && !empty($password)) {
		$result = $conn->query("SELECT * FROM sgh_admins WHERE username='$username' AND password='".md5($password)."' LIMIT 1");
...
<body>
	...
	<section class="container">
		...
		<form method="post" action="<?php echo MAIN_URL;?>admin/login" role="login">
			<h3><b>ورود</b> مدیر سیستم</h3>
			<div class="row">
				<div class="col-xs-12">
