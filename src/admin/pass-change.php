...
<div class="content-wrapper">
	...
	if (isset($_POST["pcsubmit"])) {
		...
		if (empty($passwordErr) && empty($conf_passwordErr)) 
		{
			...
			$sql = "UPDATE sgh_admins SET password='".md5($password)."' WHERE id=".$admin['id'];				
	...
	<section class="content">
		...
		<div class="box box-primary">
			...
			<!-- form start -->
			<form data-pjax method="post" action="<?php echo MAIN_URL;?>admin/pass-change" enctype="multipart/form-data" role="form">
				<div class="box-body">
